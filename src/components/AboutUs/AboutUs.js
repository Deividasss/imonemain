            ...
            <div className="relative px-5 md:text-left text-center flex justify-center items-center">
                <div className="md:max-w-[1300px]">
                    <div className="md:pt-[20%] pt-[35%] md:flex">
                        <div className="">
                            <h1 className="servicesText md:text-6xl text-5xl animate__animated animate__zoomIn animate__delay-1s">Crafting Digital Excellence, Shaping Tomorrow's Technology</h1>
                    ...
                    <div className="md:flex md:mt-72 mt-32 ">
                        ...
                        <div>
                            <h1 className="servicesText md:text-6xl text-5xl animate__animated animate__zoomIn animate__delay-1s">Our Story: Nurturing Tech Passion into Innovation</h1>
