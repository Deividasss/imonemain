...
import BlurLogo from "../../assets/image/BlurLogo.png"
            ...
            <div className="relative px-5 md:text-left text-center flex justify-center items-center">
                <div className="md:max-w-[1300px]">
                    ...
                    <div className="md:flex md:mt-72 mt-32 ">
                        <img className="md:h-[250px] md:pr-20 animate__animated animate__zoomIn animate__delay-1s" src={BlurLogo}></img>
                        <div>
                            <h1 className="servicesText text-6xl animate__animated animate__zoomIn animate__delay-1s">Our Story: Nurturing Tech Passion into Innovation</h1>
                            <p className="servicesText text-2xl mt-6 animate__animated animate__zoomIn animate__delay-1s">In the ever-evolving landscape of technology, LithoByte was born out of the visionary spirit of its founder, Deividas Kašėta. Founded not long ago, our story begins with Deividas, a tech enthusiast driven by a profound passion for innovation and a belief in the transformative power of youthful energy coupled with seasoned expertise.<br></br><br></br>
                                Join us on this journey of growth, innovation, and a shared commitment to shaping the future of technology.<br></br> LithoByte – where passion meets precision, and every project is a story of innovation waiting to be told.</p>
                            <div className="md:mx-16 md:mt-10">
                                <button className="mainButton my-5 animate__animated animate__zoomIn animate__delay-1s" onClick={() => scrollToTarget()}>Contact Us</button>
                            </div>
                        </div>
